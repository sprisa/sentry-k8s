...
{{- fail "mail.host is required when mail.enabled=true" -}}
{{- end -}}
{{- if and .Values.mail.useTls .Values.mail.useSsl -}}
{{- fail "mail.useTls and mail.useSsl cannot both be true" -}}
{{- end -}}
{{- if and .Values.mail.existingSecret (or .Values.mail.username .Values.mail.password) -}}
{{- fail "mail.existingSecret cannot be combined with mail.username or mail.password" -}}
{{- end -}}
{{- if and .Values.mail.username (not .Values.mail.password) -}}
{{- fail "mail.password is required when mail.username is set" -}}
{{- end -}}
{{- if and .Values.mail.password (not .Values.mail.username) -}}
{{- fail "mail.username is required when mail.password is set" -}}
{{- end -}}
{{- end -}}
